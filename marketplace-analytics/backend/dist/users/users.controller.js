...
__decorate([
    (0, common_1.Patch)('me'),
    (0, swagger_1.ApiOperation)({ summary: 'Обновить данные текущего пользователя' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Удалить аккаунт текущего пользователя' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Аккаунт удален' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
